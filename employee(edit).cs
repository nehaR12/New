...
{
    public partial class employee_edit_ : Form
    {
        ...
        private void employee_edit__Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection("data source=CLIENT-07\\SQLEXPRESS;integrated security=true;initial catalog=city_bus_mgmt;");
            con.Open();
            SqlCommand cmd = new SqlCommand("update emp_details set id='" + comboBox1.Text + "',f_name='" + textBox2.Text + "',l_name='" + textBox3.Text + "',dob='" + textBox4.Text + "',dl_no='" + textBox5.Text + "',address='" + textBox6.Text + "',phone='" + textBox7.Text + "',city='" + textBox8.Text + "',state='" + textBox9.Text + "',pin_code='" + textBox10.Text + "' where id='" + comboBox1.Text + "'", con);
            cmd.ExecuteNonQuery();
